...
<head>
  ...
  <link rel="icon" class="rounded-5" type="image/png" sizes="32x32" href="<?=base_url()?>/uploads/CB.png">
  <link rel="icon" class="rounded-5" type="image/png" sizes="16x16" href="<?=base_url()?>/uploads/CB.png">
